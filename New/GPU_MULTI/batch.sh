#!/bin/bash
#BSUB -J xbone_1_multi2
#BSUB -o xbone_1_multi2_%J.out
#BSUB -q hpcintrogpu
#BSUB -n 2
...
NN="128"
IT="10000"
time ./$EXECUTABLE $NN $IT $TOL $START_T $OUT
nvprof --print-gpu-summary ./$EXECUTABLE $NN $IT $TOL $START_T $OUT
